...
static const char *const yytname[] =
{
  ...
  "$accept", "line", "command", "fgCommand", "pipeCmd", "simpleCmd",
...
#line 1201 "bison.tab.c" /* yacc.c:1646  */
    break;
...
int main(int argc, char** argv) {
    ...
    printf("hervefr@computer:%s$##$ ", get_current_dir_name()); //打印提示符信息
