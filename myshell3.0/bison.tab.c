...
{
       0,    18,    18,    19,    22,    23,    27,    30,    31,    34,
      37,    40,    41,    44,    45,    48,    49
};
#endif
...
{
  "$end", "error", "$undefined", "AMP", "STRING", "PIPE", "FROM", "INTO",
  "NEWLINE", "'&'", "'|'", "'<'", "'>'", "$accept", "line", "command",
  "fgCommand", "pipeCmd", "simpleCmd", "progInvocation", "inputRedirect",
  "outputRedirect", "args", YY_NULLPTR
};
#endif
...
{
       2,    15,     0,     3,     4,     6,     7,    11,    10,     1,
       5,     0,     0,    13,    16,     8,    12,     0,     9,    14
};
...
{
       1,     9,    10,    12,    11,     0,    14,    16,    19,    17,
      15
};

static const yytype_int8 yycheck[] =
{
       4,     0,     9,    11,    10,    -1,     4,     4,     4,    12,
      11
};
...
{
       0,     4,    14,    15,    16,    17,    18,    19,    22,     0,
       9,    10,    11,    20,     4,    17,     4,    12,    21,     4
};
...
int main(int argc, char** argv) {
    ...
    printf("shz@computer:%s$$$$ ", get_current_dir_name()); //打印提示符信息
